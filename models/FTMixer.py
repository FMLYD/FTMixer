...
from layers.FTMixer_backbone import FTMixer_backbone
...
class Model(nn.Module):
    def __init__(self, configs, max_seq_len: Optional[int] = 1024, d_k: Optional[int] = None, d_v: Optional[int] = None,
        ...
        # F
        self.model = FTMixer_backbone(c_in=c_in, context_window=context_window, target_window=target_window,
                                           ...
                                           head_dropout=head_dropout,v_dropout=configs.v_dropout,
