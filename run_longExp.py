...
# PatchTST
parser.add_argument('--v_dropout', type=float, default=0.9, help='fully connected dropout')
...
parser.add_argument('--m_model', type=int, default=2, help='dimension of model')
